...
dnsp.on('connection', function (socket) {
  ...
  switch (payload['command']) {
    ...
    case "toggleCamera":
      ...
      lightArray[0]= new Array();
      lightArray[0]['r'] = 100;
      lightArray[0]['g'] = 50;
      lightArray[0]['b'] = 0;
      lightArray[1]= new Array();
      lightArray[1]['r'] = 100;
      lightArray[1]['g'] = 50;
      lightArray[1]['b'] = 0;
      lightArray[2]= new Array();
      lightArray[2]['r'] = 100;
      lightArray[2]['g'] = 50;
      lightArray[2]['b'] = 0;
      lightArray[3]= new Array();
      lightArray[3]['r'] = 100;
      lightArray[3]['g'] = 50;
      lightArray[3]['b'] = 0;
      lightArray[4]= new Array();
      lightArray[4]['r'] = 100;
      lightArray[4]['g'] = 50;
      lightArray[4]['b'] = 0;
      lightArray[5]= new Array();
      lightArray[5]['r'] = 100;
      lightArray[5]['g'] = 50;
      lightArray[5]['b'] = 0;
      lightArray[6]= new Array();   
      lightArray[6]['r'] = 100;
      lightArray[6]['g'] = 50;
      lightArray[6]['b'] = 0;
      lightArray[7]= new Array();
      lightArray[7]['r'] = 100;
      lightArray[7]['g'] = 50;
      lightArray[7]['b'] = 0;
      lightArray[8]= new Array();      
      lightArray[8]['r'] = 100;
      lightArray[8]['g'] = 50;
      lightArray[8]['b'] = 0;
      lightArray[9]= new Array();      
      lightArray[9]['r'] = 100;
      lightArray[9]['g'] = 50;
      lightArray[9]['b'] = 0;
      lightArray[10]= new Array();      
      lightArray[10]['r'] = 100;
      lightArray[10]['g'] = 50;
      lightArray[10]['b'] = 0;
      lightArray[11]= new Array();      
      lightArray[11]['r'] = 100;
      lightArray[11]['g'] = 50;
      lightArray[11]['b'] = 0;
      bulbControllers.forEach(bulb => {
